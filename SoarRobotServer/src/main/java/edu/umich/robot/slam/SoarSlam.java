...
public class SoarSlam
{
	...
	//config files, one for slam process, loopmatch process, and loopclosure process
	Config slamConfig;
    ...
    class LoopClosure
    {
        ...
        public LoopClosure(Config config)
        {
            ...
            this.closeFrequency = config.getDouble("closeFrequency", closeFrequency);
        }
        ...
        public void run(double dt)
        {
            ...
            for (int i = 0; i < autoclose_lastnode; i++) {
                ...
                //HACK - add additional structure to requirements of possible candidates:
                //		 forcing the candidates to be within a "true" distance of the maximum
