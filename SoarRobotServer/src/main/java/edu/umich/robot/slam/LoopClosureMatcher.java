...
public class LoopClosureMatcher
{
    ...
    {
        gridMap = ScanUtils.MakeModel(ptsA, -(gridmap_size / 2), -(gridmap_size / 2), gridmap_size, gridmap_size, metersPerPixel, rangeCovariance);
        clMatcher.setModel(gridMap);
    }
    ...
    public GXYTEdge match(GXYTNode a, GXYTNode b, double[] priorXYT)
    {
        ...
        double priorScale = 1.0 / (ptsB.size() * 50.0);
